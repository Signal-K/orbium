...
const GATEWAY_URL: string = process.env.NEXT_PUBLIC_GATEWAY_URL
  ? process.env.NEXT_PUBLIC_GATEWAY_URL
  : "https://gateway.pinata.cloud";

const CID: React.FC<{ fileData: FileData }> = ({ fileData }) => {
...
export async function getServerSideProps(context): Promise<{ props: { fileData: FileData } }> {
